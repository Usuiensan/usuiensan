...
// load formatter
const formatterCode = fs.readFileSync(path.join(__dirname, 'assets/js/phone-formatter.js'), 'utf8');
// load area codes
const areaCodes = JSON.parse(fs.readFileSync(path.join(__dirname, 'assets/json/phone-area-codes.json'), 'utf8'));
...
if (typeof formatFixedPhone === "function") global.formatFixedPhone = formatFixedPhone;
